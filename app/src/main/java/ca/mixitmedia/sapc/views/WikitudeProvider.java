 ...
 */
public class WikitudeProvider implements ArchitectViewHolderInterface.ILocationProvider {
    ...
    public WikitudeProvider(final Context context, LocationListener locationListener) {
        super();
