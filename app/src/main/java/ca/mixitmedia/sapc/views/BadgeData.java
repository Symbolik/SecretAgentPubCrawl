...
public class BadgeData extends SQLiteOpenHelper {
    ...
    ContentValues CVFactory(Double latitude, Double longitude ,String name, String alias, String desc){
    ...
    List<ContentValues> initialValues(){
        return Arrays.asList(
            CVFactory(43.658591, -79.377335, "Rogers Communication Centre",     "rcc",   "The Rogers Communication Centre, or RCC, is the home of the RTA School of Media, Canada’s preeminent school of media content creation, innovation and broadcasting.  RCC is also the home of the Ryerson Transmedia Zone where teams of resident storytellers build innovative projects and push the boundaries storytelling using the coolest new technologies."),
            CVFactory(43.655715, -79.382501, "Ted Rogers School of Management", "trsm",  "Welcome to the Ted Rogers School of Management or TRSM as it's known on campus.  The school has a long history of providing top-quality business education in Toronto.  TRSM houses undergrad degrees such as Business, as well as Hospitality and Tourism Management, and more!  They also have a favourite as far as I am concerned,  Information Technology Management.  TRSM also offers a number of MBAs and an MMSc programs to in this roomy building that connects to Toronto's iconic Eaton Centre."),
            CVFactory(43.657563, -79.377239, "Engineering Building",            "eng",   "the Faculty of Engineering and Architectural Science's ENG building is the place to be if you want to jump start your career in Aerospace, Civil, Electrical and Computer Engineering... let's just say if you are an engineer in the making then this is the spot.  Here's an important tid bit for you game makers and the energy innovators.  This building is where the The Ryerson game makers union and the Centre for urban energy calls home."),
            CVFactory(43.657247, -79.379594, "G. Raymond Chang School",         "chang", "This is the Chang School of Continuing Education.  With 70,000 enrolments each year.  The school boasts the title of Canada’s largest, most successful continuing education program.  The Change school is truly a leader in innovative, quality, lifelong learning."),
            CVFactory(43.657503, -79.379336, "School of Image Arts",            "img",   "The Image arts building is a signature feature of the Ryerson University campus.  At night time the building's choreographed LED lights illuminate the surrounding areas.  Students in Image arts are trained in film and photography at the bachelor level, as well as in Documentary Media, Film and Culture, and Photo Preservation at the graduate level.  If you appreciate art you can't go wrong checking out the Image arts gallery where world famous installations are often on display."),
            CVFactory(43.658797, -79.379301, "The Quad",                        "quad",  "Underneath the quad is the student gym."),
            CVFactory(43.661843, -79.380156, "Mattamy Athletic Centre",         "mat",   "The Mattamy Athletic Centre, once known as the historic Maple Leaf Gardens, is now the home of the proud Ryerson Rams!  Come here to check out a women's or men's basketball, hockey or volleyball.  Better yet come and get a work out in this classic building."),
            CVFactory(43.657942, -79.378189, "Student Centre",                  "scc",   "If you are a student at Ryerson you need to know about the student centre.  You can get your discounted TTC pass here you can get ciniplex movie passes, passes, and even free food!"),
            CVFactory(43.656568, -79.380406, "Digital Media Zone",              "dmz",   "The Digital Media Zone is a flagship of the Ryerson University campus.  the DMZ as its called is an incubation space where innovative startups are fostered.  cohorts of young talent are given resources to launch their businesses.  There are over ... Companies currently in the DMZ.  As a result of the success of the incubation space Zones have been launched across the Ryerson campus"),
            CVFactory(43.657870, -79.380390, "Library",                         "rcc",   "There's books In here")
        );
    }
    @Override
